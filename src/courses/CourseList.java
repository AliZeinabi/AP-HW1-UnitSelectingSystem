...
public class CourseList {
    ...
    public static void setGenerallist(LinkedList<generalcourse> generallist) {
        CourseList.generallist = generallist;
    }
    public LinkedList<propercourse> getProperlist() {
        return properlist;
    }
    public static void setProperlist(LinkedList<propercourse> properlist) {
        CourseList.properlist = properlist;
    }
    public static LinkedList<Object> getList() {
        return list;
    }
    public static void setList(LinkedList<Object> list) {
